...
const scheduleData = [
  { 
    ...
    items: [
      { 
        ...
        note: "抵達澳門後過關前往珠海", 
        desc: "今日於機場集合搭機前往澳門。抵達後過關前往珠海。午餐後前往廣州高鐵站，搭乘高速列車前往『山水甲天下』之美譽的桂林。桂林是中國河山中的一顆璀璨明珠，獨特的喀斯特地貌和秀美的灕江使這裡成為舉世聞名的旅遊勝地。『山青、水秀、洞奇、石美』形成了桂林獨具一格、馳名中外的自然風光。",
        map: "桃園機場" 
      },
      { 
  ...
  { 
    ...
    items: [
      ...
      { 
        ...
        note: "【核心攝影】藍調時刻與傳統漁燈", 
        desc: "這是灕江漁家人的傳統漁事活動。在清晨或傍晚，小竹筏上一盞耀眼的燈光，魚鷹借著燈光捕魚。夜幕下的江面，漁民成群結隊，乘筏遊梭，灕江山水大背景融合成一幅令人嘆為觀止的奇妙景觀。建議利用長曝捕捉燈火動態與山影。",
        map: "灕江" 
      }
    ]
  },
  { 
    ...
    items: [
      { 
        ...
        note: "捕捉灕江第一長公路橋晨曦", 
        desc: "屹立在灕江上，橋長207米。當會淩絕頂，一覽灕江水。這裡是俯瞰江面霧氣與第一道曙光的絕佳位置。",
        map: "陽朔大橋" 
      },
      { 
  ...
  { 
    ...
    items: [
      ...
      { 
        ...
        desc: "龍脊梯田規模宏大。平安壯寨保持傳統的麻欄式三層木樓，全杉木結構，是桂北地區典型的高腳幹欄型建築。『九龍』指主脈分出來的九條小山樑，『五虎』指五個微凸的小山頭，兩者被梯田所盤繞，意境深遠。晚上可拍攝最新夜景『夜龍脊』。",
        map: "龍脊梯田" 
      }
    ]
  },
  { 
    ...
    items: [
      ...
      { 
        ...
        note: "城市環城水系與地標建築", 
        desc: "環城水系包括灕江、桃花江、榕湖、杉湖等。新橋景趣相容，樓亭臺榭錯落有致。日月雙塔座落在杉湖中，日塔為金塔，月塔為銀塔，是桂林的文化地標。建議拍攝雙塔倒影與周邊建築的對稱美。",
        map: "日月雙塔" 
      },
      { 
        t: "17:00", title: "穿山公園 + 塔山日落", 
        note: "捕捉「金針、鵝管」與壽佛塔剪影", 
        desc: "穿山內有鐘乳石奇洞，佈滿如樹枝狀的碳酸鈣結晶『金針』與玻璃管狀的『鵝管』。出洞後可在園內漫步，欣賞塔山上與象鼻山普賢塔遙遙相望的壽佛塔，感受桂林山水城市的悠閒氣氛。",
        map: "塔山" 
      }
    ]
  },
  { 
    ...
    items: [
      ...
      { 
        t: "14:00", title: "珠海觀光 (愛情郵局/港珠澳大橋/城市陽台)", 
        note: "現代建築與海景攝影", 
        desc: "愛情郵局是珠海海景最佳觀景點。遠觀港珠澳大橋，這是世界最長的跨海大橋，全長55公里。城市陽台位於情侶中路，依山傍水，風景優美。隨後參觀日月貝珠海大劇院，由一大一小兩組『貝殼』組成，是中國唯一建設在海島上的歌劇院。",
        map: "珠海" 
      },
      { 
      ...
      <main className="px-6">
        ...
        {curr.items.map((it, i)=>(
          <div key={i} onClick={() => setExpandedIdx(expandedIdx === i ? null : i)} className={`bg-white p-6 rounded-[2.5rem] border-2 transition-all cursor-pointer mb-5 ${expandedIdx === i ? 'border-[#10B981] shadow-md' : 'border-[#DCFCE7]'}`}>
            ...
            {expandedIdx !== i && <p className="text-[#059669] text-[10px] italic mt-2 opacity-60">點擊查看完整歷史背景與攝影筆記...</p>}
          </div>
        ))}
