  ...
  { 
    ...
    items: [
      ...
      { 
        ...
        desc: "搭乘動車前往桂林西站。建議在車窗邊準備相機，進入廣西境內後，窗外的山勢將開始展現喀斯特地貌的奇特輪廓。抵達桂林後入住喜來登酒店。",
        map: "廣州南站" 
      }
    ]
  },
  { 
    ...
    items: [
      ...
      { 
        ...
        lens: "24-105mm", core: "三岩五井十三山、徐悲鴻寫生點",
        note: "捕捉「佳勝在興坪」的國畫意境", 
  ...
  { 
    ...
    items: [
      { 
        ...
        lens: "16-35mm / 70-200mm", core: "江面晨霧、一覽灕江水",
        note: "捕捉陽朔最長公路橋晨曦", 
  ...
  { 
    ...
    items: [
      ...
      { 
        ...
        lens: "16-35mm / 24-70mm", core: "九龍五虎線條、夜龍脊燈光",
        note: "拍攝高腳幹欄型建築與梯田", 
        desc: "龍脊梯田規模極其宏大。平安壯寨保持傳統的麻欄式三層木樓，全杉木結構，是桂北地區典型的高腳幹欄型建築。『九龍』指主脈分出來的九條小山樑，『五虎』指五個微凸的小山頭，兩者被梯田所盤繞。z字型的石板道把全寨各戶相連。",
        map: "龍脊梯田" 
      }
    ]
  },
  { 
    ...
    items: [
      { 
        ...
        lens: "24-70mm", core: "七小山包對稱感、彎彎月亮田",
        note: "捕捉宛如巨龍般的梯田線條", 
      ...
      { 
        ...
        note: "捕捉「金針、鵝管」奇觀", 
        lens: "24-70mm / 70-200mm", core: "壽佛塔剪影、鐘乳石細節",
  ...
  { 
    ...
    items: [
      ...
      { 
        ...
        lens: "iPhone / 35mm", core: "機場人文紀錄、六天影像總結",
        note: "帶著美照返回溫暖的家", 
        desc: "整理六天份量的數位顯影與回憶，搭機返台。",
        map: "澳門機場" 
      }
    ]
  }
...
const prepList = [
  { category: "攝影器材", items: [
    ...
    { name: "標準/人像 (35mm/50mm)", detail: "灕江漁火、西街人文街拍、瑤族人像" },
    { name: "中長焦 (70-200mm)", detail: "捕捉梯田壓縮感、遠景古塔特寫" },
    { name: "配件", detail: "三腳架(夜景必備)、ND減光鏡、包圍曝光遙控器" }
  ]},
  { category: "機能裝備", items: [
    { name: "防水機能外套", detail: "6月雨季必備，山區晨間防風防雨" },
    { name: "防滑鞋", detail: "龍脊石板路與江岸溼滑，需良好抓地力" }
  ]}
];
